---
description: Produce, verify, and review deliverables for a lightweight mini-project.
---

# /light-delivery

**Usage**: `/light-delivery [run_path]`
...
## Execution
1. Read `.claude/skills/light-delivery/SKILL.md` and execute its instructions.
